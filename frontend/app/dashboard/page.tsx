  ...
  return (
    <div className="max-w-9xl mx-auto px-4 pt-4 md:px-6 md:pt-8">
      ...
      <div className="mb-8 md:mb-12">
        ...
        <p className="text-muted-foreground text-sm md:text-base">Here's your {currentMonth.toLowerCase()} overview</p>
      </div>
          ...
          <Card className="border-border bg-card border p-6 shadow-sm md:p-7">
            ...
            <CardContent className="pt-0">
              <div className="space-y-2 md:space-y-3">
                ...
                <div className="text-foreground text-xl font-bold md:text-2xl">{equityProgress?.percentage || 0}%</div>
