...
import { PdfDropOverlay } from "@/components/PdfDropOverlay";
...
const Edit = () => {
  ...
  return (
    <>
      <PdfDropOverlay isDragOver={isDragOver} isExtracting={isExtracting} />
          ...
          headerActions={
            <>
              ...
              <Button variant="outline" onClick={() => fileInputRef.current?.click()} disabled={isExtracting}>
                ...
                {isExtracting ? "Extracting..." : "Import from PDF"}
              </Button>
