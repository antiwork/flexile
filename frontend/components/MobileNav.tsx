...
import ChartpieFilled from "../images/chartpie-filled.svg";
import defaultCompanyLogo from "../images/default-company-logo.svg";
import EllipsisFilled from "../images/ellipsis-filled.svg";
import FilesFilled from "../images/files-filled.svg";
import ReceiptFilled from "../images/receipt-filled.svg";
import UsersFilled from "../images/users-filled.svg";
...
const MobileNavItem = ({
  ...
  >
    <div className="relative">
      {active ? <Image src={iconActive} alt="Icon" /> : <Icon className="size-5" />}
      {badge && badge > 0 ? (
