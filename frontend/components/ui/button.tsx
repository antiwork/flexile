  ...
  "inline-flex items-center justify-center border rounded-md gap-1.5 whitespace-nowrap cursor-pointer disabled:opacity-50 [&[inert]]:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed [&:has(svg:only-child)]:px-2 px-3",
  {
    variants: {
      variant: {
        ...
        auth: "bg-secondary text-foreground border-muted hover:bg-black hover:border-black dark:bg-white/5 dark:hover:bg-white/85",
        primary:
        ...
        accent: "bg-blue-600 text-white border-blue-600 hover:bg-blue-500 hover:border-blue-500",
        ...
        ghost: "border-transparent text-muted-background hover:bg-secondary",
