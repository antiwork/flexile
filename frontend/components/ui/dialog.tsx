    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          isMobile
            ? "top-auto right-4 bottom-20 left-4 h-auto max-h-[80vh] rounded-2xl p-6 [box-shadow:0px_4px_6px_-4px_#0000001A,0px_10px_15px_-3px_#0000001A]"
      ...
      >
        ...
        {showCloseButton && !hideCloseButton ? (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring/15 data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-[26px] right-5 cursor-pointer rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none md:mt-2 md:mr-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
