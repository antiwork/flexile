    ...
    <AlertDialogPortal data-slot="alert-dialog-portal">
      <AlertDialogOverlay className="grid place-items-center overflow-auto">
        <AlertDialogPrimitive.Content
          ...
          className={cn(
            "border-border bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 grid w-full max-w-[calc(100%-2rem)] content-start gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg",
            className,
          )}
          {...props}
        >
