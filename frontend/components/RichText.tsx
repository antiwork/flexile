  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        class: cn(
          className,
          "prose text-foreground dark:prose-invert max-h-100 overflow-y-auto px-8 py-4 p-4 min-h-60 max-h-96 overflow-y-auto max-w-full rounded-b-md outline-none",
        ),
      },
    },
    immediatelyRender: false,
