...
# Run this in the backend directory: ruby debug_bank_account.rb
...
# Find your company (you'll need to update this with your company ID or email)
...
# Option 2: Find by ID (if you know it)
...
puts
puts "To manually fix (if needed):"
