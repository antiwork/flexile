...
test.describe("Invoice submission, approval and rejection", () => {
  ...
  test("allows contractor to submit/delete invoices and admin to approve/reject them", async ({ page }) => {
    ...
    await fillByLabelSafe(page, "Hours / Qty", "0:23");
    ...
    await fillByLabelSafe(page, "Hours / Qty", "04:30", { index: 0, blur: true });
    ...
    await fillByLabelSafe(page, "Hours / Qty", "0:33");
    ...
    await fillByLabelSafe(page, "Hours / Qty", "10:23");
    ...
    await expect(page.getByRole("heading", { name: "Edit invoice" })).toBeVisible();
    await fillByLabelSafe(page, "Hours / Qty", "02:30");
