...
test.describe("invoice editing", () => {
  ...
  test("displays fresh data across edit and show pages after re-submission", async ({ page }) => {
    ...
    // Verify initial data is loaded correctly in edit form
