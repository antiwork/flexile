...
ActiveRecord::Schema[8.0].define(version: 2025_05_27_225258) do
  ...
  create_table "company_contractors", force: :cascade do |t|
    ...
    t.boolean "contract_signed_elsewhere", default: false, null: false, comment: "Indicates if the contractor has already signed a contract elsewhere, negating the need for a Flexile consulting agreement"
