...
class InvoiceEquityCalculator
  ...
  def calculate
    ...
    if company.equity_enabled? && equity_percentage.nonzero? && (!unvested_grant.present? || (equity_amount_in_options > 0 && unvested_grant.unvested_shares < equity_amount_in_options))
      return nil
    end
