...
class Api::V1::OauthController < Api::BaseController
  ...
  def google
    ...
    begin
      user = find_or_create_google_user(email, name, google_id, image, invitation_token)
  ...
  private
    def find_or_create_google_user(email, name, google_id, image, invitation_token)
      ...
      if user
        ...
        complete_google_user_signup(email, name, google_id, image, invitation_token)
      end
    end
