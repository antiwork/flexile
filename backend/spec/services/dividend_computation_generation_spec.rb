...
RSpec.describe DividendComputationGeneration do
  ...
  it "generates records as expected" do
    ...
    expect do
      dividend_computation = described_class.new(company, amount_in_usd: 1_000_000, return_of_capital: false, release_document: "Test release document for {{investor}} with {{amount}}", name: "Test Distribution 2024").process
